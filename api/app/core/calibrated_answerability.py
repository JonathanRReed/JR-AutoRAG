...
class CalibratedAnswerability:
    ...
    def compute_score(
        ...
        coverage_aspects: Optional[list[tuple[str, bool]]] = None,
    ) -> AnswerabilityScore:
    ...
    def _score_coverage(
        self,
        coverage_aspects: Optional[list[tuple[str, bool]]],
    ) -> float:
...
_answerability_scorer: Optional[CalibratedAnswerability] = None
