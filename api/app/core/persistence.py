...
class IndexPersistence:
    ...
    def _tokenized_legacy_path(self, index_name: str) -> Path:
    ...
    def save_sparse_index(
        ...
        # Save tokenized corpus as JSON to avoid pickle deserialization vulnerabilities
    ...
    def load_sparse_index(
        ...
        bm25_path = self._bm25_path(index_name)
        tokenized_path = self._tokenized_path(index_name)
        legacy_tokenized_path = self._tokenized_legacy_path(index_name)
        metadata_path = self._metadata_path(f"{index_name}_sparse")

        has_tokenized = tokenized_path.exists() or legacy_tokenized_path.exists()
        if not (bm25_path.exists() and metadata_path.exists() and has_tokenized):
            return None, None, None
        ...
        if tokenized_path.exists():
            ...
            with open(legacy_tokenized_path, "rb") as f:
    ...
    def delete_index(self, index_name: str) -> None:
        ...
        paths = [
            ...
            self._tokenized_legacy_path(index_name),
