...
class TestConflictDetector:
    def test_no_conflicts(self):
        ...
        chunks = [
            ...
            EvidenceChunk(
                id="2", title="B", snippet="Python runs on many platforms.", score=0.8
            ),
        ]
    ...
    def test_detects_negation_conflict(self):
        ...
        chunks = [
            EvidenceChunk(
                id="1",
                title="A",
                snippet="Python is easy to learn. It is beginner-friendly.",
                score=0.9,
            ),
            EvidenceChunk(
                id="2",
                title="B",
                snippet="Python is not easy to learn. It has complex syntax.",
                score=0.8,
            ),
        ]
        result = detector.detect(chunks)
